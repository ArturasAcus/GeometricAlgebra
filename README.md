...
3. Open Examples/01_Start.nb notebook and try to repeat calculations.
...
- Series of elementary functions (one MV argument functions only) 
- Functions of MV (arbitrary Cl(p,q) algebras, non-diagonalizable/defective MV) 
...
- Non-commutative coefficients (takes values in Clifford algebra) for calculations with arbitrary Clifford algebra 
- Commutative geometric product (makes possible computations with multiple imaginary units)
...
- Examples folder demonstrate real usage examples
- Documentation folder contains function documentation notebooks (just started)
